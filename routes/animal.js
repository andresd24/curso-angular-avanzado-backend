...
var md_updload = multipart({uploadDir: './uploads/animals'});
...
api.post('/upload-image-animal/:id', [md_auth.ensureAuth, md_admin.isAdmin, md_updload], AnimalController.updloadImage);
